...
- After changing `.github/renovate.json5`, validate the config with `docker run --rm --volume=$(pwd)/.github/renovate.json5:/github/renovate.json5:ro kokuwaio/renovate-config-validator:latest`.
